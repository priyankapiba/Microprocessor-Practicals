%macro print 2   ;to print message on the screen
mov rax,1
mov rdi,1
mov rsi,%1
mov rdx,%2
...
%macro gtch 1                ;macro for accept from keyboard
...
dispbuff resb 2             ;to store ASCII value
input   resb 1              
choice resb 1 
section .txt                
global _start
